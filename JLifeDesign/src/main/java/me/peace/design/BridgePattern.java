...
public class BridgePattern {
    ...
    static class GreenPaint implements Paint {
    ...
    static class WhitePaint implements Paint {
    ...
    static abstract class BaseShape implements Shape{
    ...
    static class Circle extends BaseShape{
        private static final String TAG = Circle.class.getSimpleName();

        @Override
        public void draw() {
            LogUtils.i(TAG,"draw circle[" + paint.getColor() + "]");
        }
    }
    ...
    static class Rectangle extends BaseShape{
        ...
        @Override
        public void draw() {
            LogUtils.i(TAG,"draw rectangle[" + paint.getColor() + "]");
        }
    }

    static class Square extends BaseShape{
        private static final String TAG = Square.class.getSimpleName();

        @Override
        public void draw() {
            LogUtils.i(TAG,"draw square[" + paint.getColor() + "]");
        }
    }
}
