...
public class SimpleFactoryPattern {
    public static void main(String[] args) {
        Player player = Factory.getProduct(ProductType.MP4);
        player.music();
        player.info();

        player = Factory.getProduct(ProductType.PHONE);
        player.music();
        player.info();
    }
    ...
    static final class Factory {
        ...
        public static Player getProduct(ProductType type) {
            Player product = null;
            switch (type) {
                case MP4:
                    product = new MP4Player();
                    break;
                case PHONE:
                    product = new Phone();
                    break;
