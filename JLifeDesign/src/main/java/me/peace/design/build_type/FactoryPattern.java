...
public class FactoryPattern {
    public static void main(String[] args) {
        ...
        Logger logger = fileFactory.create();
        logger.log("writing data into file");

        logger = databaseFactory.create();
        logger.log("write data into database");
    }
    ...
    static class FileFactory implements LoggerFactory{
        @Override
    ...
    static class DatabaseFactory implements LoggerFactory{
        @Override
        public Logger create() {
